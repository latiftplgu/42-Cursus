...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/29 03:01:19 by ltopluog          #+#    #+#             */
/*   Updated: 2022/12/29 03:11:21 by ltopluog         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	image_create(t_data *data)
{
	...
	data->img.coin = mlx_xpm_file_to_image(data->mlx, "img/zurg.xpm",
			&data->img.img_w, &data->img.img_h);
	data->img.wall = mlx_xpm_file_to_image(data->mlx, "img/wall.xpm",
			&data->img.img_w, &data->img.img_h);
	data->img.door = mlx_xpm_file_to_image(data->mlx, "img/door.xpm",
			&data->img.img_w, &data->img.img_h);
	data->img.character = mlx_xpm_file_to_image(data->mlx, "img/buzz.xpm",
			&data->img.img_w, &data->img.img_h);
}
